import 'package:e_wallet/pages/screens/transactions/widgets/build_transactions_users.dart';
                  ...
                  children: [
                    Expanded(
                      child: Container(
                        ...
                        child: ElevatedButton(
                          child: Text("Thu nhập", style: Theme.of(context).textTheme.titleMedium),
                          onPressed: () {
                            setState(() {
                              _toggleButton = true;
                            });
                    ...
                    Expanded(
                      child: Container(
                        ...
                        height: double.infinity,
                        child: ElevatedButton(
                          child: Text("Chi tiêu", style: Theme.of(context).textTheme.titleMedium),
                          onPressed: () {
                            setState(() {
                              _toggleButton = false;
                            });
...
//                         height: double.infinity,
//                         child: ElevatedButton(
//                           child: Text("Thu nhập", style: Theme.of(context).textTheme.headline2),
//                           onPressed: () {
//                             setState(() {
//                               _toggleButton = true;
//                             });
...
//                         height: double.infinity,
//                         child: ElevatedButton(
//                           child: Text("Chi tiêu", style: Theme.of(context).textTheme.headline2),
//                           onPressed: () {
//                             setState(() {
//                               _toggleButton = false;
//                             });
