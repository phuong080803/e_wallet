import '../pages/screens/contacts/screens/contacts_screen.dart';
...
import 'package:e_wallet/pages/screens/transactions/screens/transactions_screen.dart';
...
class E_WalletLayoutController {
  ...
  static List<_BoardingItem> item = [
    ...
    _BoardingItem(
        label: "Giao dịch", icon: Icon(Iconly_Broken.Wallet), screen: TransactionsScreen()),
    _BoardingItem(label: "Danh bạ", icon: Icon(Iconly_Broken.User1), screen: ContactsScreen()),
